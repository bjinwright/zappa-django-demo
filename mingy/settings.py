"""
Django settings for mingy project.
...
INSTALLED_APPS += env('EXTRA_APPS','[]',var_type='list')
...
MIDDLEWARE += env('EXTRA_MIDDLEWARE','[]',var_type='list')

ROOT_URLCONF = 'mingy.urls'


TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': ['{0}/mingy/templates'.format(BASE_DIR)],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'mingy.wsgi.application'
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR,'mingy','static'),
)
...
AWS_STORAGE_BUCKET_NAME = env('AWS_STORAGE_BUCKET_NAME','ipoots-zappa')

AWS_S3_CUSTOM_DOMAIN = '{0}.s3.amazonaws.com'.format(AWS_STORAGE_BUCKET_NAME)


STATICFILES_LOCATION = env('STATICFILES_LOCATION','mingy_static')
STATICFILES_STORAGE = 'util.custom_storages.StaticStorage'
STATIC_URL = env('STATIC_URL',"https://{0}/{1}/".format(AWS_S3_CUSTOM_DOMAIN, STATICFILES_LOCATION))
